...
os.environ["SHEET_ID"] = "13y1coklHJzw85RltZv5XXeMbwm_lm--5zXPaK9Ani4Q"
...
class TestLocalScripts(unittest.TestCase):
    ...
    def test_get_csv(self):
        ...
        subprocess.call(["python", "get_csv.py", os.environ.get("SHEET_ID"), downloaded_file])
    ...
    def helper_get_images_check_size(self, file_name, expected):  # Expected in Kb
        ...
        subprocess.call(["python", "get_csv.py", os.environ.get("SHEET_ID"), csv_datapath])
        subprocess.call(["python", "get_images.py", os.environ.get("SHEET_ID"), folder_path, csv_datapath])
